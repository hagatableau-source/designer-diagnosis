...
const personalityLongDescriptions: Record<string, string> = {
  flowObserver: `導線観測者は、「人がどう動くか」を見る人格です。誰がどこへ向かい、どこで止まり、どこで迷い、どこに引き寄せられるのかを無意識に観察しています。街を歩いていても、店の入口の配置や、人が自然に集まる場所に目が向きます。会話の中ですら、「この話題になると人の視線が移動する」「ここで空気が流れた」と感じ取っています。
...
conceptEditor:`概念編集者は、「曖昧な考えを整理する」人格です。人の話を聞くと、頭の中で自然に整理が始まり、「つまりこういうことですね」と骨格化してしまいます。断片的な情報を繋ぎ、言葉になっていない思想を整理し直す能力に長けています。
このタイプは、情報を増やすよりも“不要なものを削ぎ落として本質を残す”ことを得意とします。そのため、ブランド設計、思想整理、コンセプト設計、ネーミングなどに強い適性があります。感情より構造に意識が向くため、議論の熱量より論理的な整合性を優先する傾向があります。一方で、人の熱意や衝動を整理しすぎてしまい、冷たく見られることもあります。本人は世界を「理解可能な形にしたい」という欲求で動いています。`,
 ...
 behaviorObserver: `行行動観測者は、「人の無意識行動」を見る人格です。話し方や表情よりも、指の動き、視線、歩き方、スマホの持ち方など、本人すら意識していない行動パターンに強く反応します。
...
temperatureSensor:`温度感知者は、「感情温度」を感じ取る人格です。言葉ではなく、場の湿度、静けさ、距離感、呼吸感のようなものを感じています。誰かが怒っていることを表情より先に察知したり、場の緊張感を肌で理解したりします。
...
contextReader:`文脈解読者は、「なぜそうなったか」を掘り下げる人格です。このタイプは、表面の言葉だけを見ません。その発言が生まれた歴史、関係性、空気、文化的背景まで読み取ろうとします。
...
airArchitect:`空気構築者は、「場の雰囲気」を設計する人格です。このタイプは、「何を作るか」より先に、「どんな空気を作るか」を考えています。
...
sensoryEditor:`感覚編集者は、「美しさと気持ちよさを整える」人格です。このタイプは、色、質感、音、余白、リズムなどを無意識に調律しています。「なんか綺麗」「なんか気持ちいい」を、偶然ではなく再現可能な形へ整えていきます。
...
behaviorDirector:`行動演出者は、「人が動きたくなる空気」を作る人格です。このタイプは、空気、熱量、期待感を使って、人の行動を自然に誘導します。
...
conceptSensor:`概概念感知者は、「思想を感覚で理解する」人格です。このタイプは、言葉になる前の空気やイメージを感じ取っています。
...
airObserver:`空気観測者は、「場の変化を監視する」人格です。温度感知者が空気を感じるタイプだとすれば、この人格は空気の変化量を測定しているタイプです。
...
uxReader:`UX解読者は、「なぜ人がそう感じるのか」を解読する人格です。このタイプは、「なぜ人はこれを使いやすいと感じるのか」を構造レベルで考えています。
...
obsessiveBuilder:`執着構築者は、「理想形への異常なこだわり」を持つ人格です。このタイプは、「まだ良くできる」が止まりません。
...
experienceSensor:`体験感知者は、「身体がどう感じるか」を見る人格です。このタイプは、「押した時の感触」「動いた時の気持ちよさ」「触れた瞬間の違和感」を非常に強く感じます。
ゲーム、デバイス、UI、空間などにおいて、“身体がどう反応するか”を基準に世界を見ています。理論ではなく、実際の感覚を重視するため、「なんか気持ちいい」が極めて重要です。感覚優位なため、論理説明は苦手ですが、体験設計の精度は非常に高い人格です。`,

airConceptualizer:`空気概念者は、「時代の空気」を思想とする人格です。このタイプは、「今なぜこれが流行るのか」「なぜこの雰囲気が支持されるのか」を感覚ではなく、思想として捉えています。
